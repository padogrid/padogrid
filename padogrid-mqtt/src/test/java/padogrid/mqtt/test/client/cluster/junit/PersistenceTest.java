...
/**
 * PersistenceTest configures with "etc/mqttv5-persistence.yaml" to publish to
 * "test/mytopic".
 * 
 * @author dpark
 *
...
public class PersistenceTest {
	...
	public static void setUp() throws Exception {
		System.setProperty(IClusterConfig.PROPERTY_CLIENT_CONFIG_FILE, "etc/mqttv5-persistence.yaml");

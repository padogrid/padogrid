...
public class PortableFactoryImpl implements PortableFactory {
	...
	public static final int FACTORY_ID = Integer.getInteger("org.hazelcast.addon.hql.impl.PortableFactoryImpl.factoryId", 10000);

	private static final int __FIRST_CLASS_ID = Integer.getInteger("org.hazelcast.addon.hql.impl.PortableFactoryImpl.firstClassId", 10000);

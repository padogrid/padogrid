...
public class LikeTest {
	...
	@Test
	public void testLike1() throws IOException, HqlException {

		Path path = Paths.get("test/hql/like1.txt");
		try {
	...
	@Test
	public void testLike2() throws IOException, HqlException {

		Path path = Paths.get("test/hql/like2.txt");
		try {
			System.out.println(path);
			CompiledQuery<?> cq = hql.compile(path);
			cq.dump();
	...
	@Test
	public void testLike3() throws IOException, HqlException {

		Path path = Paths.get("test/hql/like3.txt");
		try {
			System.out.println(path);
			CompiledQuery<?> cq = hql.compile(path);
			cq.dump();

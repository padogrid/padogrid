...
public class AliasTest {
	...
	@Test
	public void testAlias1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/alias1.txt");
	...
	@Test
	public void testAlias2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/alias2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testAlias3() throws IOException, HqlException {
		Path path = Paths.get("test/hql/alias3.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testAlias4() throws IOException, HqlException {
		Path path = Paths.get("test/hql/alias4.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

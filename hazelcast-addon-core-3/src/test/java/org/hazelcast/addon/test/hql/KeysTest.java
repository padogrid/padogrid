...
public class KeysTest {
	...
	@Test
	public void testKeys1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/keys1.txt");
	...
	@Test
	public void testKeys2() throws IOException, HqlException {

		Path path = Paths.get("test/hql/keys2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testKeys3() throws IOException, HqlException {

		Path path = Paths.get("test/hql/keys3.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testKeys4() throws IOException, HqlException {

		Path path = Paths.get("test/hql/keys4.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

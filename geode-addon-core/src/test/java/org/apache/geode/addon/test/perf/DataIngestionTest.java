 ...
 * mock data into the {@link RegionNameEnum#eligibility} and
 * {@link RegionNameEnum#profile} maps. It launches multiple threads to
...
public class DataIngestionTest implements Constants
{
	...
	private void runTest(RegionNameEnum mapNameEnum, int batchSize, int totalEntryCount, int threadCount, int payloadSize, String prefix, TestCaseEnum testCaseEnum) throws Exception
	{
	...
	abstract class AbstractThread extends Thread
	{
		...
		AbstractThread(int threadNum, RegionNameEnum mapNameEnum, int batchSize, int threadStartIndex, int entryCountPerThread, int payloadSize, String prefix)
		{
	...
	{
		public EligibilityPutThread(int threadNum, RegionNameEnum mapNameEnum, int batchSize, int threadStartIndex,
	...
	{
		public EligibilityPutAllThread(int threadNum, RegionNameEnum mapNameEnum, int batchSize, int threadStartIndex,
				int entryCountPerThread, int payloadSize, String prefix)
		{
			super(threadNum, mapNameEnum, batchSize, threadStartIndex, entryCountPerThread, payloadSize, prefix);
		}
	...
	class ProfilePutThread extends AbstractThread
	{
		...
		public ProfilePutThread(int threadNum, RegionNameEnum mapNameEnum, int batchSize, int threadStartIndex, int entryCountPerThread, int payloadSize, String prefix)
		{
			super(threadNum, mapNameEnum, batchSize, threadStartIndex, entryCountPerThread, payloadSize, prefix);
		}
	...
	class ProfilePutAllThread extends AbstractThread
	{
		...
		public ProfilePutAllThread(int threadNum, RegionNameEnum mapNameEnum, int batchSize, int threadStartIndex, int entryCountPerThread, int payloadSize, String prefix)
		{
			super(threadNum, mapNameEnum, batchSize, threadStartIndex, entryCountPerThread, payloadSize, prefix);
		}

...
# Set Redisson addon class path. This is to handle 'none' and non-spark clusters.
CLASSPATH="$PADOGRID_HOME/spark/plugins/*:$PADOGRID_HOME/spark/lib/*:$PADOGRID_HOME/lib/*"

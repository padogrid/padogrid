...
# Set another Hadoop version to download it via the 'build_app' script. This value
# overrides the workspace product (Hadoop) version. This variable should be set if
# your application does not require Hadoop locally installed.
#ANOTHER_HADOOP_VERSION=

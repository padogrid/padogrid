...
# Set Redisson addon class path. This is to handle 'none' and non-snappydata clusters.
CLASSPATH="$PADOGRID_HOME/snappydata/plugins/*:$PADOGRID_HOME/snappydata/lib/*:$PADOGRID_HOME/lib/*"

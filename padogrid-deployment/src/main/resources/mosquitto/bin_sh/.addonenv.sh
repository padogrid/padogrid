...
. $SCRIPT_DIR/.utilenv_mosquitto.sh "$@"
...
# PATH
#
export PATH="$SCRIPT_DIR:$PADOGRID_HOME/bin_sh:$MOSQUITTO_HOME/sbin:$MOSQUITTO_HOME/bin:$MOSQUITTO_HOME/src:$MOSQUITTO_HOME/client:$PATH"

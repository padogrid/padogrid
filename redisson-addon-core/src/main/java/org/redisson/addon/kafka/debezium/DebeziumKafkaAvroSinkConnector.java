...
public class DebeziumKafkaAvroSinkConnector extends SinkConnector {
	...
	public void start(Map<String, String> props) {
		...
		hazelcastClientConfigFile = parsedConfig.getString(REDISSON_CLIENT_CONFIG_FILE_CONFIG);
	...
	public List<Map<String, String>> taskConfigs(int maxTasks) {
		...
		for (int i = 0; i < maxTasks; i++) {
			...
			if (hazelcastClientConfigFile != null) {
				config.put(REDISSON_CLIENT_CONFIG_FILE_CONFIG, hazelcastClientConfigFile);
			}
			if (mapName != null) {

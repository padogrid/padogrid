...
import org.redis.addon.kafka.debezium.DebeziumKafkaSinkConnector;
...
public class DebeziumKafkaSinkTask extends SinkTask {
	...
	public void start(Map<String, String> props) {
		...
		String redissonConfigFile = props.get(DebeziumKafkaSinkConnector.REDISSON_CONFIG_FILE_CONFIG);

...
import org.redis.addon.redisson.kafka.debezium.DebeziumKafkaSinkTask;

/**
 * DebeziumKafkaSinkConnector registers the Redisson connector for Kafka.
 * 
 * @author dpark
 *
 */
public class DebeziumKafkaSinkConnector extends SinkConnector {
	...
	public static final String REDISSON_CONFIG_FILE_CONFIG = "redisson.config";

	private static final ConfigDef CONFIG_DEF = new ConfigDef()
			.define(REDISSON_CONFIG_FILE_CONFIG, Type.STRING, "/redisson-addon/etc/redisson-client.yaml",
			...
			.define(KEY_CLASS_NAME_CONFIG, Type.STRING, null, Importance.HIGH,
					"Key class name. Name of serializable class for transforming table key columns to key objects into Redisson. "
			...
			.define(VALUE_CLASS_NAME_CONFIG, Type.STRING, null, Importance.HIGH,
					"Value class name. Name of serializable class for transforming table rows to value objects into Redisson. "
	...
	private String redissonClientConfigFile;
	...
	public void start(Map<String, String> props) {
		...
		redissonClientConfigFile = parsedConfig.getString(REDISSON_CONFIG_FILE_CONFIG);
	...
	public List<Map<String, String>> taskConfigs(int maxTasks) {
		...
		for (int i = 0; i < maxTasks; i++) {
			...
			if (redissonClientConfigFile != null) {
				config.put(REDISSON_CONFIG_FILE_CONFIG, redissonClientConfigFile);
			}
			if (mapName != null) {

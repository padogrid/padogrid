...
public class AndOrTest {
	...
	@Test
	public void testAndOr1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/and_or1.txt");
	...
	@Test
	public void testAndOr2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/and_or2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testAndOr3() throws IOException, HqlException {
		Path path = Paths.get("test/hql/and_or3.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

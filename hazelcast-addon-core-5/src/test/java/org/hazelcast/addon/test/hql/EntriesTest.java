...
public class EntriesTest {
	...
	@Test
	public void testEntries1() throws IOException, HqlException {

		Path path = Paths.get("test/hql/entries1.txt");
	...
	@Test
	public void testEntries2() throws IOException, HqlException {

		Path path = Paths.get("test/hql/entries2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testEntries3() throws IOException, HqlException {
		Path path = Paths.get("test/hql/entries3.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

...
public class ValuesTest {
	...
	@Test
	public void testValues1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/values1.txt");
	...
	@Test
	public void testValues2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/values2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
	...
	@Test
	public void testValues3() throws IOException, HqlException {
		Path path = Paths.get("test/hql/values3.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

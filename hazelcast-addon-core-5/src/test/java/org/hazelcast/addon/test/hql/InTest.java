...
public class InTest {
	...
	@Test
	public void testIn1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/in1.txt");
	...
	@Test
	public void testIn2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/in2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

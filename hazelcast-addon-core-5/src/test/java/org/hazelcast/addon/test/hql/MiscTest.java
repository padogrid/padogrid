...
public class MiscTest {
	...
	@Test
	public void testMisc1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/misc1.txt");
	...
	@Test
	public void testMisc2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/misc2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();

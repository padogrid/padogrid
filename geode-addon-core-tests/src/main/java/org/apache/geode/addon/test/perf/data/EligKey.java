 ...
 *
 */
public class EligKey implements DataSerializable, PartitionResolver<String, EligKey>
{	
	 ...
	 */
	@Override
	public Object getRoutingObject(EntryOperation<String, EligKey> opDetails) {
		return groupNumber;
	}

	@Override
	public String getName() {
		return "EligKeyResolver";
	}
}

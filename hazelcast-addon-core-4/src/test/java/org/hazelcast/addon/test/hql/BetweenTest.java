...
public class BetweenTest {
	...
	@Test
	public void testBetween1() throws IOException, HqlException {
		Path path = Paths.get("test/hql/between1.txt");
	...
	@Test
	public void testBetween2() throws IOException, HqlException {
		Path path = Paths.get("test/hql/between2.txt");
		System.out.println(path);
		CompiledQuery<?> cq = hql.compile(path);
		cq.dump();
		System.out.println();
